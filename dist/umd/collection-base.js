...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./arrayLikeIterable", "./CollectionBase", "./copyIterableTo", "./indexIterable", "./IterableBase", "./IterableCollectionBase", "./ReadOnlyCollectionBase", "./ReadOnlyIterableCollectionBase"], factory);
    }
    ...
    const arrayLikeIterable_1 = tslib_1.__importDefault(require("./arrayLikeIterable"));
    ...
    const ReadOnlyIterableCollectionBase_1 = tslib_1.__importStar(require("./ReadOnlyIterableCollectionBase"));
